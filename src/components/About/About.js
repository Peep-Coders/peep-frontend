		...
		<div className={styles.about_body}>
			<div className={styles.container_row1}>
				...
				<div className={styles.container_title}>
					...
					<p className={styles.about_p}>
						...
						End. <br></br> For this project I utilized HTML5, CSS3, JavaScript,
						REACT Native.
					</p>
				</div>
				<a
				...
				<div className={styles.container_title}>
					...
					<p className={styles.about_p}>
						...
						In this Twitter clone project (PeeP) I primarily worked on the Back
						End. <br></br> For this project I utilized Python3 and Django!
					</p>
				</div>
			</div>
			<div className={styles.container_row2}>
				...
				<div className={styles.container_title}>
					...
					<p className={styles.about_p}>
						Hi my name is Michel Pathinvo, I'm a Full-Stack Developer! <br></br>{' '}
						In this Twitter clone project (PeeP) I worked on the Full-Stack.{' '}
						<br></br> I used: HTML5, CSS3, JavaScript, REACT, Python3, Django.
					</p>
				</div>
				<a
